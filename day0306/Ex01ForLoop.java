...
// for 반복문
// 조건이 만족되면 횟수에 상관없이 계속 돌아가던 while 반복문과는 다르게
...
public class Ex01ForLoop {
    public static void main(String[] args) {
        ...
        // 7. i++; i의 현재값: 3
        // 8. ㅑ <= 3; i의 현재값이 3 이므로 true
        // 9. System.out.println("i의 현재값: "+i);
        // 10. i++; i의 현재값: 4
        // 11. i <= 3; i의 현재값이 4 이므로 false
        // 12. for문 종료
        ...
        // 4. 여러분이 초기 단계에서 가장 많이 하는 실수는
        // i 자리에 1을 넣는 실수를 많이한다.
        // 이러면 무한루프가 되거나 아예 for문이 시작안할수도 있으니 주의해야한다.

        // 5. i 도 하나의 변수이다. 즉 유효범위가 for문 내부인 변수가 되니깐
        // 중복 선언을 조심해야한다.

        // 6. 다른 제엉문들도 마찬가지이지만, for 문도 () 뒤에 ; 을 붙이면
