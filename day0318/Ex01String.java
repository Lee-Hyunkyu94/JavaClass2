...
public class Ex01String {
    public static void main(String[] args) {
        // String 이란 여러개의 문자를 한번에 관리하는 클래스이다.
        // String 클래스 안에는 여러개의 문자를 다루거나 비교하거나 확인하는데 유용한 다양한 메소드가 미리 구현되어 있다.

        String str1 = new String("abcDEF");

        // 1. charAt()
        //    String에 특정 index에 있는 글자가 무엇인지 알려준다.
        //    String은 내부적으로 일종의 char 배열이 존재하기 때문에
        //    index가 따로 존재하는 것이다.
        //    다른 index를 다루는 메소드 처럼 잘못된 index는
        ...
        System.out.println("str1.subString(3): " + str1.substring(3)); // i+1부터
        System.out.println("str1.subString(1,8): " + str1.substring(1,8));//i j 라면 j-1까지
        ...
        // 7. toUpperCase()
        //    toUpperCase()는 현재 문자열을 모두 대문자로 바꾼 문자열을 return해준다.
        //    원본은 변하지 않는다.
        ...
        str1 = new String("\t\t\t12346\t78910      \n\n");
        System.out.println("str1: " + str1);
        System.out.println("str1.trim(): " + str1.trim()); // 가운데 \t는 의미가 달라질 수 있어 없애지 않는다.
