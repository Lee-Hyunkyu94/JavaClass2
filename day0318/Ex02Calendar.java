...
public class Ex02Calendar {
    public static void main(String[] args) {
        ...
        // cal 을 직접 찍어보자
        System.out.println("cal: " + cal); // MONTH 만 0부터 시작 
        ...
        // "2021년 03월 18일 화요일 PM(오후) 03시 36분 30초" 의 형식대로 출력이 된다.
        
        System.out.println(sdf.format(cal.getTime()));
        
        // Calendar 객체에 원하는 시간을 넣는 방법
        // 1. 1970년 01월 01일 0시 0분 부터 원하는 시간까지를 1/1000 초 단위로 구해서 직접 값을 넣는다.
        // 2. 원하는 연월일 시분초에 직접 setter를 통해서 값을 넣어준다.
        //    단, 연월일 시분초를 각각 넣어주는 것이 아니라
        ...
        String str = "으하하하하하하"; // String str = "2021.01.01"
        sdf = new SimpleDateFormat("yyyy.MM.dd");
        // 어떤 종류던 간에
        // parse는 한가지 잠재적 위험요소가 존재한다.
        // 바로 parse가 안되는 값을 바꾸려고 할 때가 그 잠재적 위험요소가 된다.
