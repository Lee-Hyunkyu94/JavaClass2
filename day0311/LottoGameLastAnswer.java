...
public class LottoGameLastAnswer {
    ...
    public static void main(String[] args) {
        ...
        // 현재 computerArray의 몇번 인덱스에 값을 저장할 지를 할당한 int 변수 index
        int index = 0;

        // index 변수의 할당된 값이 SIZE 보다 작은 동안,
        // while을 이용하여 computerArray의 index번 index에 random이 생성한 숫자를
        ...
        while (index < SIZE) {
            ...
            // for 문을 사용하여, randomNumber의 값과 computerArray의 element 중
            // 같은 값을 가진 element가 있으면 inputSwich를 false로 바꾸고
            // for 문을 break한다.
        ...
        for (int i = 0; i < userArrays.length; i++) {
            ...
            if (userChoice == 1) {
                ...
                while (index < userArrays[i].length) {
                    ...
                    // 그 외엔 false가 할당되는 boolean 변수 inputSwitch

                    // 이번 경우에는 inputSwich의 초기화 값이
                    // 단순히 true가 아니라
                    ...
                    // for문을 사용해서, userNumber 와 중복되는 숫자가 있으면 inputSwitch의 값을 false로 바꾸고
                    // break 해주자
