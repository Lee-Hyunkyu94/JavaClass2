...
// M: Model
//    모델은 컨트롤러가 뷰어에 데이터를 보내줄때나, 뷰어가 보내준 데이터를 데이터베이스로 보낼때
...
//    만약 해당 객체의 값이 수정도 되는 경우에는 DTO, 값을 읽어오는 용도일 때는 VO 라고 하지만
...
//    데이터베이스가 있을 경우 뷰어의 요청에 맞춰서 CRUD를 하게 된다.
//    컨트롤러의 경우 이름이 컨트롤러로 끝난다.
